...
class Ui(object):
    ...
    def get_com_port_address(self)->str:
        ...
        if address.find("COM") == -1:
            raise Exception("Invalid COM PORT address. Need address like 'COMi' where 'i' is 1, 2, ... n.")       
    ...
    def get_w_registers_data(self)->RegData:
        return RegData(
            ...
            BIAS_CORE_CUR=self.get_code_from_box(self.ui.comboBox_BIAS_CORE_CUR.currentText()),
            ...
            CMP_TH=self.get_code_from_box(self.ui.comboBox_CMP_TH.currentText()),
            ...
            CFG_SW_force_EN=self.get_code_from_box(self.ui.comboBox_CFG_SW_force_EN.currentText()),
            ...
            EMUL_ADDR_i=self.get_code_from_box(self.ui.comboBox_EMUL_ADDR_i.currentText()),
            EMUL_EN_L0=self.get_code_from_box(self.ui.comboBox_EMUL_EN_L0.currentText()),
            EMUL_EN_L1=self.get_code_from_box(self.ui.comboBox_EMUL_EN_L1.currentText()),
            EMUL_tau_v=self.get_code_from_box(self.ui.comboBox_EMUL_tau_v.currentText()),
            EMUL_L0_v=self.get_code_from_box(self.ui.comboBox_EMUL_L0_v.currentText()),
